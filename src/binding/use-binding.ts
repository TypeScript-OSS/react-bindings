...
const defaultDeps: DependencyList = Object.freeze([]);
...
Binding<GetType> & ExtraFieldsT => useMemo(() => makeBinding<GetType, ExtraFieldsT>(initialValue, args), args.deps ?? defaultDeps);
